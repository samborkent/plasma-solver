...
nMin    = 1E8;     % Plasma threshold
nMinBG  = 1E8;     % Background gas threshold
...
if createConfigBool
    createConfigFile( currentPath, folder, fileName, commentString, ... % File settings
        plotTimes, plotVeloDistBool, plotDensityBool, plotLogBool, plot2DBool, saveFiguresBool, saveFormat, ... % Preferences
